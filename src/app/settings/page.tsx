    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-6 space-y-4 max-w-3xl">
          ...
          <p className="text-sm text-[var(--fg-muted)]">Configuración del entorno y credenciales</p>

          <div className="bg-[var(--bg-elevated)] border border-[var(--border)] rounded p-5">
            <h2 className="text-sm font-semibold text-[var(--fg-soft)] mb-3">Meta Access Token</h2>
            {tokenOk === null && <div className="text-sm text-[var(--fg-muted)]">Verificando…</div>}
            {tokenOk === true && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-[var(--fg-muted)] mt-1">
                    {accountCount} cuentas accesibles. Token configurado vía variable de entorno <code className="font-mono bg-[var(--surface-2)] px-1 rounded">META_ACCESS_TOKEN</code>.
                  </div>
                </div>
              </div>
            )}
            {tokenOk === false && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-medium text-[var(--danger)]">Token inválido o no configurado</div>
                  <div className="text-xs text-[var(--fg-muted)] mt-1">
                    Agregar <code className="font-mono bg-[var(--surface-2)] px-1 rounded">META_ACCESS_TOKEN</code> en Environment Variables de Vercel.
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="bg-[var(--bg-elevated)] border border-[var(--border)] rounded p-5">
            <h2 className="text-sm font-semibold text-[var(--fg-soft)] mb-3">Repositorio</h2>
            <a
          ...
          <div className="bg-[var(--bg-elevated)] border border-[var(--border)] rounded p-5">
            <h2 className="text-sm font-semibold text-[var(--fg-soft)] mb-3">Versión + roadmap</h2>
            <ul className="text-sm space-y-2 text-[var(--fg-soft)]">
